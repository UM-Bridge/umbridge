...
| Implementation | Optional Error Checks | Allow Parallel Requests | Allow `Inf` & `NaN` Output | Allow Shared Memory Communication | Allow MessagePack |
|----------------|-----------------------|-------------------------|----------------------------| --------------------------------- |------------------ |
| Python         | Yes                   | Yes                     | WIP                        | Yes                               | Yes               |
| C++            | Yes                   | Yes                     | No                         | Yes                               | No                |
| Julia          |  No                   | Yes                     | Yes                        | No                                | No                |
